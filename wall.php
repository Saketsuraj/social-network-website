...
<body id="wall">
    ...
    <header class="text-right">
        ...
        <div class="second-icon menu-icon">
            <span><a href="personal-profile.html" title="Profile"><span class="hidden-xs hidden-sm">Profile</span> <i
                        class="fa fa-user" aria-hidden="true"></i></a>
            </span>
        </div>
        <div class="second-icon menu-icon">
            <span><a href="wall.html" title="Wall"><span class="hidden-xs hidden-sm">Wall</span> <i
    ...
    <div class="sidebar-nav">
        ...
        <h2 class="text-center hidden-xs"><a href="personal-profile.html" title="Profile"><?php  echo $_SESSION["username"]; ?></a></h2>
            ...
            <div class="card-post">
                <div class="row">
                    ...
                    <div class="col-xs-9 col-sm-10 info-user">
                        <h3><a href="personal-profile.html" title="Profile" value="<?php echo $username; ?>"></a></h3>
                        <p><i>2h</i></p>
                    </div>
                </div>
                <div class="row">
